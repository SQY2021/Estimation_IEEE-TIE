...
%  由 MATLAB 于 12-Sep-2023 08:45:04 自动生成

% 创建 figure
figure1 = figure('Tag','TRAINING_PLOTPERFORM','NumberTitle','off',...
    'Name','神经网络训练 性能 (plotperform)，轮: 180 , Training finished: Met performance criterion');
...
% 创建 xlabel
xlabel('180 轮','FontWeight','bold','FontSize',12);

% 创建 title
title('最佳 验证 性能是第 180 轮的 1.2894e-05','FontWeight','bold','FontSize',12);
