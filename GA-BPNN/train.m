...
%  由 MATLAB 于 12-Oct-2023 10:57:08 自动生成

% 创建 figure
figure1 = figure('Tag','TRAINING_PLOTPERFORM','NumberTitle','off',...
    'Name','神经网络训练 性能 (plotperform)，轮: 165');
...
% 创建 xlabel
xlabel('165 轮','FontWeight','bold','FontSize',12);

% 创建 title
title('最佳 验证 性能是第 165 轮的 0.00069113','FontWeight','bold','FontSize',12);
