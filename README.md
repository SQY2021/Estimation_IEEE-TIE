...
Illustrative results demonstrate that the combined **[AVM+BPNN+GA](https://)** model outperforms other existing proposals and is capable of achieving accurate results for both the estimation and prediction of parasitic and control parameters.
